...
*   [Don't use Response.Cookies[string] to check if a cookie exists!]({% post_url 2009-01-26-don-t-use-response.cookies-string--to-check-if-a-cookie-exists %})
*   [Use wrappers to access your cookies, sessions, ...]({% post_url 2009-01-26-use-wrappers-to-access-your-cookies-sessions %})
