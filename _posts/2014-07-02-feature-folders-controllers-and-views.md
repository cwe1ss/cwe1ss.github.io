...
The first step in our process to [a better folder structure for our MVC projects]({% post_url 2014-04-07-introducing-the-asp.net-mvc-feature-folders-project-structure %}) is to make sure, MVC can resolve our Controllers and Views. This is our target structure:
