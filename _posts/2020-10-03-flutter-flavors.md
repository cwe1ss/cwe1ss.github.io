...
![Both flavors are installed on android](/images/posts/flutter_flavors_app_icons_on_android.png)
...
![Configurations in XCode](/images/posts/flutter_flavors_ios_configurations.png)
...
![live scheme in XCode](/images/posts/flutter_flavors_ios_live_scheme.png)

Back in the "schemes" list, you can now delete the existing "Runner" scheme. This should result in the list looking like this:

![scheme list in XCode](/images/posts/flutter_flavors_ios_schemes.png)
...
![flavor setting in XCode](/images/posts/flutter_flavors_ios_flavor_setting.png)
...
![bundle id per ios config](/images/posts/flutter_flavors_ios_bundle_id.png)
...
![app name per ios config](/images/posts/flutter_flavors_ios_app_name.png)
